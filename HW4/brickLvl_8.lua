...
-- File: brickLvl_8.lua
--
-- Desc: This file sets up and displays level 8 of the game. Refer to forrestLvl_1.lua 
...
function nextLevel() 
  ...
  composer.gotoScene("brickLvl_9", options)
end
...
--local background = display.newImage("wooddungeon.png", wid/2, 280 )
  ...
  lvlNum = 8
  trapNum = 5
  trapLoc = {{x = 162, y = 369}, {x = 208, y = 386}, {x = 119, y = 384}, {x = 131, y = 160}, {x = 192, y = 159}}

  forrestLvl_1 = { 
  	lamp = 8,
  	lamps = {{x = 177, y = 203}, {x = 150, y = 203}, {x = 56, y = 454}, {x = 260, y = 453}, {x = 260, y =260}, {x = 62, y = 280}, {x = 62, y = 101}, {x = 261, y = 104}},
    powerType = 2,
    powerUp = {1, 1},
    powerUpImages = {"heart.png", "hourglass.png"},
    powerUps = {{x = 91, y = 448}, {x = 224, y = 120}},
    enemy = 3,
    enemies = {{x = 78, y = 269}, {x = 245, y = 117}, {x = 75, y = 114}},
    enemyTracks = {{x = 247, y = 269}, {x = 248, y = 445}, {x = 77, y = 442}},
    door = 4,
    imageDoor = "door.png",
    doors = {{x = 193, y = 200}, {x = 131, y = 200}, {x = 118, y = 336}, {x = 207, y = 336}},
 	sideWall = 4,
	imageName = "sideWallBrick.png",
	sideWalls = {{x = 129, y = 227},{x = 192, y = 227},{x = 114, y = 301},{x = 205, y = 301}},
	downWall = 12,
	imageName2 = "downWallBrick.png",
	downWalls = {{x = 162, y = 139},{x = 162, y = 167},{x = 99, y = 176},{x = 223, y = 176},{x = 227, y = 331},{x = 227, y = 377},{x = 181, y = 331},{x = 181, y = 420},{x = 138, y = 331},{x = 138, y = 420},{x = 96, y = 331},{x = 96, y = 377}},
...
-- Play the background music on channel 1, loop infinitely, and fade in over 5 seconds 
   ...
   elseif ( phase == "did" ) then
    live_die()
   	local themeMusicChannel = audio.play( soundTable["souls3"], {channel=1, loops=-1} )
