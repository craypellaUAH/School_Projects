...
-- File: brickLvl_9.lua
--
-- Desc: This file sets up and displays level 9 of the game. Refer to forrestLvl_1.lua 
...
--local background = display.newImage("wooddungeon.png", wid/2, 280 )
  ...
  lvlNum = 9
  trapNum = 6
  trapLoc = {{x = 196, y = 152}, {x = 136, y = 152}, {x = 135, y = 259}, {x = 197, y = 252}, {x = 193, y = 415}, {x = 131, y = 415}}

  forrestLvl_1 = { 
  	lamp = 8,
  	lamps = {{x = 93, y = 358}, {x = 234, y = 220}, {x = 56, y = 454}, {x = 260, y = 453}, {x = 92, y =220}, {x = 62, y = 104}, {x = 234, y = 358}, {x = 261, y = 104}},
    powerType = 2,
    powerUp = {3, 1},
    powerUpImages = {"heart.png", "hourglass.png"},
    powerUps = {{x = 164, y = 322}, {x = 164, y = 188}, {x = 71, y = 285}, {x = 253, y = 284}},
    enemy = 6,
    enemies = {{x = 253, y = 113}, {x = 256, y = 454}, {x = 74, y = 452}, {x = 73, y = 117}, {x = 77, y = 186}, {x = 254, y = 320}},
    enemyTracks = {{x = 256, y = 454}, {x = 253, y = 113}, {x = 73, y = 117}, {x = 74, y = 452}, {x = 254, y = 189}, {x = 71, y = 318}},
    door = 3,
    imageDoor = "door.png",
    doors = {{x = 104, y = 119}, {x = 162, y = 119}, {x = 224, y = 119}},
 	sideWall = 4,
	imageName = "sideWallBrick.png",
	sideWalls = {{x = 132, y = 215},{x = 195, y = 215},{x = 132, y = 352},{x = 195, y = 352}},
	downWall = 9,
	imageName2 = "sideWallBrickSmall.png",
	downWalls = {{x = 103, y = 150},{x = 164, y = 150},{x = 224, y = 150},{x = 103, y = 279},{x = 164, y = 279},{x = 224, y = 279},{x = 103, y = 413},{x = 164, y = 413},{x = 224, y = 413}},
  }
...
-- Play the background music on channel 1, loop infinitely, and fade in over 5 seconds 
   ...
   elseif ( phase == "did" ) then
    live_die()
   	local themeMusicChannel = audio.play( soundTable["souls2"], {channel=1, loops=-1} )
